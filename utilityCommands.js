...
class UtilityCommands {
    ...
    async serverInfoSlash(interaction) {
        try {
            ...
            await interaction.reply({ content: 'Error fetching server information', ephemeral: true });
        }
    }
    ...
    async avatarSlash(interaction) {
        ...
        await this.ackService.send(interaction, avatarText);
    }
    ...
    async bannerSlash(interaction) {
        ...
        await this.ackService.send(interaction, bannerText);
    }
    ...
    async memberCountSlash(interaction) {
        try {
            ...
            await interaction.reply({ content: 'Error fetching member statistics', ephemeral: true });
        }
    }
